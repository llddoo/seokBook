...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <!-- Bootstrap core CSS -->
	<link href="${pageContext.request.contextPath}/resources/docs/4.6/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-B0vP5xmATw1+K9KRQjQERJvTumQW0nPEzvF6L/Z6nronJ3oUOFUFpCjEUQouq2+l" crossorigin="anonymous">
...
<link rel="mask-icon" href="${pageContext.request.contextPath}/resources/docs/4.6/assets/img/favicons/safari-pinned-tab.svg" color="#563d7c">
